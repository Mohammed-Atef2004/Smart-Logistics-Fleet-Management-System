...
{
    public class CreateMaintenanceRecordHandler:IRequestHandler<CreateMaintenanceRecordCommand,Guid>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        public CreateMaintenanceRecordHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
