...
{
    public class GetAllMaintenanceRecordsHandler:IRequestHandler<GetAllMaintenanceRecordsQuery,List<MaintenanceRecordDto>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        public GetAllMaintenanceRecordsHandler(Domain.Interfaces.Repositories.IUnitOfWork unitOfWork, AutoMapper.IMapper mapper)
        {
