...
{
    public class GetMaintenanceAlertsHandler: IRequestHandler<GetMaintenanceAlertsQuery, List<MaintenanceAlertDto>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public GetMaintenanceAlertsHandler(IUnitOfWork unitOfWork)
        {
