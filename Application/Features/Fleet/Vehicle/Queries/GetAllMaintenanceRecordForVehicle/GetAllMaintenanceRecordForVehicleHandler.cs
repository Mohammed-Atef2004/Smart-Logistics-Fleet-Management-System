...
{
    public class GetAllMaintenanceRecordForVehicleHandler:IRequestHandler<GetAllMaintenanceRecordForVehicleQuery,List<MaintenanceRecordDto>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

    
        public GetAllMaintenanceRecordForVehicleHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
